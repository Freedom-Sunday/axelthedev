<?php
  ...
  */
  ...
  $receiving_email_address = 'ifypariz16@gmail.com';
  ...
  $contact->subject = 'New Message from Contact Form';
  ...
  */
  ...
  $contact->add_message( sanitize_input($_POST['name']), 'From');
  $contact->add_message( sanitize_input($_POST['email']), 'Email');
